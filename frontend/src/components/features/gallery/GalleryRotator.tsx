  ...
  const fetchData = async () => {
    try {
      ...
      const [itemsRes, categoriesRes] = await Promise.all([
        safeFetch(`${apiEndpoint}/items`, { timeout: 5000 }),
        safeFetch(`${apiEndpoint}/categories`, { timeout: 5000 }),
      ]);
      ...
      if (itemsRes.success && categoriesRes.success) {
        ...
        // Use fallback data
        const fallbackData = getFallbackGalleryData();
  ...
  const getFallbackGalleryData = () => ({
    items: [
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=1200',
        category: { _id: 'healthcare', name: 'Healthcare' }
      }
    ],
    categories: [
      ...
      { _id: 'water', name: 'Clean Water' },
      { _id: 'empowerment', name: 'Women Empowerment' },
      { _id: 'environment', name: 'Environment' },
      { _id: 'community', name: 'Community Events' }
    ]
  });
